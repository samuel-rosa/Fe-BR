...
Aqui você fica sabendo mais sobre os conjuntos de dados de ferro do solo que já recebemos e tem acesso direto
e irrestrito à cada um deles. Fique à vontade para descarregar e usar os dados... E lembre de citar os seus 
autores originais!

Antes de acessar os dados, é preciso esclarecer que classificamos os conjuntos de dados de acordo com o tipo 
de estudo que os originou, ou seja, pedológicos ou edafológicos (veja mais informações abaixo). A partir disso,
identificamos os dois maiores conjuntos de dados de cada tipo de estudo, os quais serão premiados com a
coautoria de um artigo a ser submetido para publicação na revista 
[Earth System Science Data](http://earth-system-science-data.net/) (Fator de Impacto > 8). Estão excluídos 
dessa premiação os conjuntos de dados descarregados do Sistema de Informação de Solos Brasileiros 
([SISB](https://www.bdsolos.cnptia.embrapa.br/consulta_publica.html)) e aqueles produzidos no Setor de 
Pedologia da Universidade Federal de Santa Maria (UFSM).

Agora sim! Vamos aos conjuntos de dados que já temos disponíveis!
...
pedology <- rank(do.call(rbind, pedology)[, -4]) # uf
# DT::datatable(pedology[, -4], rownames = FALSE, escape = FALSE)
DT::datatable(pedology[, -c(1, 6)], rownames = FALSE, escape = FALSE)
# knitr::kable(
  # pedology[, -4], # n
...
edafology <- rank(do.call(rbind, edafology)[, -4]) # uf
DT::datatable(edafology[, -c(1, 6)], rownames = FALSE, escape = FALSE)
# knitr::kable(
  # edafology[, -4], # n
  # format = "html", table.attr = "width='100%'",
  # caption = paste(
