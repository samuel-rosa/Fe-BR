...
knitr::kable(
  ...
  caption = "Classificação dos pesquisadores -- e instituições -- reponsáveis pelos conjuntos de dados pedológicos de ferro do solo. As contribuições podem ser acessadas clicando no respectivo número de registros.")
```
...
knitr::kable(
  edafology[, -5], format = "html", table.attr = "width='100%'",
    caption = "Classificação dos pesquisadores -- e instituições -- reponsáveis pelos conjuntos de dados edafológicos de ferro do solo. As contribuições podem ser acessadas clicando no respectivo número de registros.")
```
