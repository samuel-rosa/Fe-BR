...
[contato](contact.html) conosco.

A forma de submissão preferencial dos dados é via planilha eletrônica. Para isso, preparamos um ***modelo de
planilha eletrônica*** usando os padrões internacionais da [WoSIS](http://www.isric.org/data/wosis) e que contém
estrutura compatível com a estrutura do próprio Fe-BR. Versões para usuários de LibreOffice (formato ODS) e
Microsoft Office (formato XLSX) podem ser descarregadas de:

* LibreOffice: http://www.ufsm.br/febr/templates/template.ods
* Microsoft Office: http://www.ufsm.br/febr/templates/template.xlsx

Uma versão Google Sheets do modelo de planilha eletrônica, onde você pode fazer comentários e sugerir 
alterações, está disponível no seguinte endereço:
...
determinação. Note que nossas listas de códigos não são exaustivas. Entre em [contato](contact.html) conosco 
caso você use métodos analíticos diferentes daqueles apresentados aqui para que possamos definir os códigos 
mais apropriados. Lembre que o sucesso de nosso projeto depende da sua colaboração!
